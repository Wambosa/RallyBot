...
namespace Tai {
    ...
    class Program {
        ...
        private static Dictionary<TAI_COMMAND, TaiMethod> TaiTakeCareOfThis = new Dictionary<TAI_COMMAND, TaiMethod>() {
			...
			{TAI_COMMAND.INSERT_TASK, CLIMethod.CreateTaskForStory},
			{TAI_COMMAND.INSERT_MY_STORY_TASKS, CLIMethod.CreateMyStoryTasks},
			{TAI_COMMAND.INSERT_QA_BOILERPLATE, CLIMethod.CreateQABoilerplate},
			{TAI_COMMAND.INSERT_DEV_LEAD_BOILERPLATE, CLIMethod.CreateDevLeadBoilerplate},
